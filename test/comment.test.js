...
describe('Comment Manager Module', () => {
    ...
    describe('Error Handling', () => {
        ...
        test('should log errors with context', () => {
            ...
            expect(mockYouTubeErrorBoundary.logError).toHaveBeenCalledWith(
                error,
                { context: 'test' }
            );
        });
    ...
    describe('Utility Functions', () => {
        test('should use debounce from YouTubeUtils', () => {
            const fn = jest.fn();
            const debounced = mockYouTubeUtils.debounce(fn, 100);
    ...
    describe('Style Management', () => {
        test('should add styles via StyleManager', () => {
            ...
            expect(mockYouTubeUtils.StyleManager.add).toHaveBeenCalledWith(
                'test-styles',
                styles
            );
        });
    ...
    describe('Cleanup Management', () => {
        test('should register observers for cleanup', () => {
            ...
            expect(mockYouTubeUtils.cleanupManager.registerObserver).toHaveBeenCalledWith(
                observer
            );
        });
        ...
        test('should register event listeners for cleanup', () => {
            ...
            const key = mockYouTubeUtils.cleanupManager.registerListener(
                document,
                'click',
                handler,
                { passive: true }
